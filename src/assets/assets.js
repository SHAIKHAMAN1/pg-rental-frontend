...
export const ownerMenuLinks = [
    ...
    { name: "Add PG", path: "/owner/add-pg", icon: addIcon, coloredIcon: addIconColored },
    { name: "Manage PGs", path: "/owner/manage-pg", icon: carIcon, coloredIcon: carIconColored },
...
export const dummyDashboardData = {
  ...
  bedsSummary: {
    single: { total: 20, available: 6 },
    double: { total: 40, available: 14 },
    triple: { total: 30, available: 3 }
  },
